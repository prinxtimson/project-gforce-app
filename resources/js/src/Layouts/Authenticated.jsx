    ...
    return (
        <div className="tw-grow tw-bg-orange-200">
            ...
            <div className="tw-max-w-8xl tw-mx-auto tw-px-4 sm:tw-px-6 md:tw-px-8">
                <section
                    className="tw-hidden lg:tw-block tw-fixed tw-z-20 tw-inset-0 tw-left-[max(0px,calc(50%-45rem))] tw-right-auto tw-w-[19.5rem] tw-p-10 tw-overflow-y-auto tw-bg-amber-700"
                    style={{ top: "4.4rem" }}
                >
                    <Sidebar />
                </section>
